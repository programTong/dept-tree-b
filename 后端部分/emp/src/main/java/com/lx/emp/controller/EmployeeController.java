...
public class EmployeeController {
    ...
    public boolean removeBatch(@RequestBody List<Integer> ids){
        return employeeService.removeBatch(ids);
    }
...
//    @GetMapping("/get")
//    public Employee getOneByEmpNo(@RequestParam("empNo") String empNo){
//        return employeeService.findByNO(empNo);
//    }

    @GetMapping("/get/{empId}")
    public Employee getOneByEmpId(@PathVariable("empId") Integer empId){
