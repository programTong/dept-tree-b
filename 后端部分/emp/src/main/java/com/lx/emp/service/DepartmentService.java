...
public class DepartmentService {
    ...
    @OperationLogDetail(detail = "根据IDS删除部门",level = 4,operationUnit = OperationUnit.DEPARTMENT,operationType = OperationType.DELETE)
    public boolean removeBatch(List<String> ids) {
        return departmentMapper.deleteBatchById(ids)>0;
    }
