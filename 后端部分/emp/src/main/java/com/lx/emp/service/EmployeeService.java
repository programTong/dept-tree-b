...
public class EmployeeService {
    ...
    @OperationLogDetail(detail = "根据IDs删除员工",level = 4,operationUnit = OperationUnit.EMPLOYEE,operationType = OperationType.DELETE)
    public boolean removeBatch(List<Integer> ids){
        return employeeMapper.deleteBatchById(ids) > 0;
    }
